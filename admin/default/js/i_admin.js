(function($) {
    ...
    $(document).on("mouseup touchend", function(e) {
        var boxContainer = $('.i_choose_country , .i_limit_list_container , .i_limit_list_ch_container , .i_limit_list_cp_container , .i_limit_list_p_container , .i_limit_list_s3_container, .i_point_sub_list_container');
