...
<div class="i_contents_container">
    <div class="i_general_white_board border_one column flex_ tabing__justify">
        ...
        foreach($reportedPostList as $rData){
            ...
            $reportedPostID = $rData['reported_post'];
        ...
        <tr class="transition trhover">
            ...
            <td class="see_post_details" id="<?php echo filter_var($qID, FILTER_SANITIZE_STRING);?>"><div class="flex_ tabing_non_justify plink_"><a href="<?php echo filter_var($base_url, FILTER_VALIDATE_URL).'post/'.$reportedPostID;?>" target="blank_"><div class="pe_active flex_ tabing"><?php echo $iN->iN_SelectedMenuIcon('10').$LANG['see_reported_post'];?></div></a></div></td>
                ...
                <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                    <div class="i_chck_text" style="padding-right:15px;"><?php echo filter_var($LANG['not_checked'], FILTER_SANITIZE_STRING);?></div>
                        <label class="el-switch el-switch-yellow" for="rCheckStatus<?php echo $qID;?>">
                          <input type="checkbox" name="rCheckStatus" class="rchmdReport q<?php echo $qID;?>" id="rCheckStatus<?php echo $qID;?>" data-id="<?php echo $qID;?>" <?php echo filter_var($qContactReadStatus, FILTER_SANITIZE_STRING) == '1' ? 'value="0" checked="checked"' : 'value="1"';?>>
                        <span class="el-switch-style"></span>  
                        </label> 
                        <input type="hidden" name="rCheckStatus" class="rCheckStatus" value="<?php echo filter_var($qContactReadStatus, FILTER_SANITIZE_STRING);?>">
            ...
            <td class="flex_ tabing">
                <div class="flex_ tabing_non_justify">
                    <div class="delr border_one transition" id="<?php echo filter_var($qID, FILTER_SANITIZE_STRING);?>"><?php echo $iN->iN_SelectedMenuIcon('28').$LANG['delete'];?></div>
                 </div>
            </td> 
        </tr>
        <?php }?>
