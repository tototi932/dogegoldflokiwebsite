<div class="i_contents_container">
    <div class="i_general_white_board border_one column flex_ tabing__justify">
       ...
       <div class="i_general_row_box column flex_" id="general_conf">  
            ...
            <!---->
            <div class="i_general_row_box_item flex_ tabing_non_justify">
               <div class="irow_box_left tabing flex_"><?php echo filter_var($LANG['website_default_email'], FILTER_SANITIZE_STRING);?></div>
               <div class="irow_box_right">
                 <input type="text" name="smtp_host_email" class="i_input flex_" value="<?php echo filter_var($smtpEmail, FILTER_SANITIZE_STRING);?>">
                 <div class="rec_not"><?php echo filter_var($LANG['default_email_not'], FILTER_SANITIZE_STRING);?></div>
               </div>
            </div>
            <!---->
            <!---->
