            ...
            <div class="i_general_row_box_item flex_ column tabing__justify" >
                <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                  <label class="el-switch el-switch-yellow" for="sfstat">
                    <input type="checkbox" name="sPlStatus" class="sfstat" id="sfstat" <?php echo filter_var($freeLiveStreamingStatus, FILTER_SANITIZE_STRING) == '1' ? 'value="1" checked="checked"' : 'value="0"';?>>
                    <span class="el-switch-style"></span>  
                  </label>
                  <div class="i_chck_text"><?php echo filter_var($LANG['free_live_streaming_status'], FILTER_SANITIZE_STRING);?></div> 
                  <input type="hidden" name="sPlStatus" id="sftats3" value="<?php echo filter_var($freeLiveStreamingStatus, FILTER_SANITIZE_STRING);?>">
                </div>
                <div class="rec_not" style="padding-left:15px;"><?php echo filter_var($LANG['free_live_streaming_status_not'], FILTER_SANITIZE_STRING);?></div>
            </div>
            <!---->
            <!---->
            <div class="i_general_row_box_item flex_ column tabing__justify" >
                <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                  <label class="el-switch el-switch-yellow" for="spstat">
                    <input type="checkbox" name="sflStatus" class="spstat" id="spstat" <?php echo filter_var($paidLiveStreamingStatus, FILTER_SANITIZE_STRING) == '1' ? 'value="1" checked="checked"' : 'value="0"';?>>
                    <span class="el-switch-style"></span>  
                  </label>
                  <div class="i_chck_text"><?php echo filter_var($LANG['paid_live_streaming_status'], FILTER_SANITIZE_STRING);?></div> 
                  <input type="hidden" name="sflStatus" id="sptats3" value="<?php echo filter_var($paidLiveStreamingStatus, FILTER_SANITIZE_STRING);?>">
                </div>
                <div class="rec_not" style="padding-left:15px;"><?php echo filter_var($LANG['paid_live_streaming_status_not'], FILTER_SANITIZE_STRING);?></div>
            </div>
            <!---->
            <!---->
