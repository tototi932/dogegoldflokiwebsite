<div class="i_admin_left">
  ...
  <div class="i_admin_menu_wrapper flex_ column">
      <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>index">
        ...
        <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['general', 'limits','website_settings','billing_informations','affiliate_settings']) ? "active_p" : ""; ?>" data-id="settings">
        ...
        <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['general', 'limits','website_settings', 'billing_informations','affiliate_settings']) ? 'sub_in' : '' ?>" id="settings">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>affiliate_settings">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'affiliate_settings' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['affiliate_settings'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a>
        </div>
      ...
      <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>manage_products">
        <div class="menu_item flex_ tabing_non_justify transition border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'manage_products' ? "active_p" : ""; ?>">
            <div class="flex_ tabing menu_svg"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('158'));?></div><div class="flex_ lm"><?php echo filter_var($LANG['u_products'], FILTER_SANITIZE_STRING);?></div>
        </div>
      </a>
      ...
      <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>manage_social_profiles">
        <div class="menu_item flex_ tabing_non_justify transition border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'manage_social_profiles' ? "active_p" : ""; ?>">
            <div class="flex_ tabing menu_svg"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('126'));?></div><div class="flex_ lm"><?php echo filter_var($LANG['manage_social_profiles'], FILTER_SANITIZE_STRING);?></div>
        </div>
      </a>
      <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>manage_announcement">
        <div class="menu_item flex_ tabing_non_justify transition border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'manage_announcement' ? "active_p" : ""; ?>">
            <div class="flex_ tabing menu_svg"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('171'));?></div><div class="flex_ lm"><?php echo filter_var($LANG['manage_announcement'], FILTER_SANITIZE_STRING);?></div>
        </div>
      </a>
      ...
      <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['allPosts', 'premiumPosts','for_subscribers', 'awaiting_approval','storiePosts']) ? "active_p" : ""; ?>" data-id="manage_posts">
        ...
        <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['allPosts', 'premiumPosts','for_subscribers', 'awaiting_approval','storiePosts']) ? 'sub_in' : '' ?>" id="manage_posts">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>storiePosts">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'storiePosts' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['manage_storie_posts'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a>
      ...
      <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['customcssjs', 'svgicons','manage_landing_page','landing_question_answer','text_story_backgrounds']) ? "active_p" : ""; ?>" data-id="design">
        ...
        <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['customcssjs', 'svgicons','manage_landing_page','landing_question_answer','text_story_backgrounds']) ? 'sub_in' : '' ?>" id="design">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>text_story_backgrounds">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'text_story_backgrounds' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['text_story_backgrounds'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a>
        </div>
      <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['manage_point_packages','manage_point_packages_live','manage_point_settings']) ? "active_p" : ""; ?>" data-id="point">
        ...
        <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['manage_point_packages','manage_point_packages_live','manage_point_settings']) ? 'sub_in' : '' ?>" id="point">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>manage_point_packages_live">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'manage_point_packages_live' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['live_point_packages_settings'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a>
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>manage_point_settings">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'manage_point_settings' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['manage_point_settings'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a> 
        </div>
      ...
      <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['manage_users','creator_requests','fake_user_generator']) ? "active_p" : ""; ?>" data-id="user">
        ...
        <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['manage_users','creator_requests','fake_user_generator']) ? 'sub_in' : '' ?>" id="user">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>fake_user_generator">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'fake_user_generator' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['fake_user_generator'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a> 
        </div>
      ...
      <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['payment_settings','paypal','bitpay','stripe','authorizenet','iyzico','razorpay','paystack','ccbill_subscription_settings']) ? "active_p" : ""; ?>" data-id="payments">
        ...
        <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['payment_settings','paypal','bitpay','stripe_subscribtion_settings','stripe','authorizenet','iyzico','razorpay','paystack','ccbill_subscription_settings','coinpayment_settings']) ? 'sub_in' : '' ?>" id="payments">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>coinpayment_settings">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'coinpayment_settings' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['coinpayment_settings'], FILTER_SANITIZE_STRING);?></div>
              </div>
            </a>
