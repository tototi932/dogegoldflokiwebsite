   ...
   <div class="i_modal_in_in"> 
       <div class="i_modal_content" id="general_conf">  
            ...
            <div class="i_modal_g_header">
                <?php echo filter_var($LANG['create_new_announcement'], FILTER_SANITIZE_STRING);?>
            ...
            <div class="announcement_type_choose">
                ...
                <div class="irow_box_right">
                    <div class="i_box_limit flex_ column">
                        <div class="i_limit" data-type="ch_limit"><span class="lct">Share with Everyone</span><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('36'));?></div>
                            <div class="i_limit_list_ch_container">
                                <div class="i_countries_list border_one column flex_"> 

                                <div class="i_s_limit transition border_one gsearch creators" id='creators' data-c="<?php echo filter_var($LANG['a_share_with_creators'], FILTER_SANITIZE_STRING);?>" data-type="chooseAnnouncementType"><?php echo filter_var($LANG['a_share_with_creators'], FILTER_SANITIZE_STRING);?></div>
                                <div class="i_s_limit transition border_one gsearch everyone" id='everyone' data-c="<?php echo filter_var($LANG['a_share_with_everyone'], FILTER_SANITIZE_STRING);?>" data-type="chooseAnnouncementType"><?php echo filter_var($LANG['a_share_with_everyone'], FILTER_SANITIZE_STRING);?></div>
            ...
            <div class="i_editsvg_code flex_ tabing">
               <textarea class="svg_more_textarea" name="announcementText" placeholder="<?php echo filter_var($LANG['wrire_announcement_description'], FILTER_SANITIZE_STRING);?>"></textarea>
            </div>
            <!---->
...
$(document).ready(function(){ 
    ...
    var newAnnouncementForm = $("#newAnnouncementForm");
    newAnnouncementForm.on('submit', function(e) {
        ...
        jQuery.ajax({
            ...
            beforeSend: function() {
                ...
                newAnnouncementForm.find(':input[type=submit]').prop('disabled', true);
            },
            success: function(data) {
                setTimeout(() => {
                    newAnnouncementForm.find(':input[type=submit]').prop('disabled', false);
                }, 3000);
                if (data == '200') {
                    location.reload();
                }else if(data == '2'){
