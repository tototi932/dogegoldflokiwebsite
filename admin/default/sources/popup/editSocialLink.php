   ...
   <div class="i_modal_in_in"> 
       <div class="i_modal_content general_conf">  
            ...
            <div class="i_modal_g_header">
                <?php echo filter_var($LANG['edit_social_site'], FILTER_SANITIZE_STRING);?>
            ...
            <div class="i_plnn_container flex_" style="padding: 20px 20px;padding-top: 10px;">    
                <input type="text" name="social_site" class="point_input" placeholder="<?php echo filter_var($LANG['social_site_link_ex'], FILTER_SANITIZE_STRING);?>" value="<?php echo filter_var($sData['place_holder'], FILTER_SANITIZE_STRING);?>">
            </div>
            <div class="i_plnn_container flex_" style="padding: 20px 20px;padding-top: 0px;">    
                <input type="text" name="socail_key" class="point_input" placeholder="<?php echo filter_var($LANG['social_site_key'], FILTER_SANITIZE_STRING);?>" value="<?php echo filter_var($sData['skey'], FILTER_SANITIZE_STRING);?>">
            </div>
            <!--/Modal Header-->
            <div class="i_editsvg_code flex_ tabing">
               <textarea class="svg_more_textarea" name="socialsvgcode" placeholder="<?php echo filter_var($LANG['social_site_icon_code'], FILTER_SANITIZE_STRING);?>"><?php echo html_entity_decode($sData['social_icon']);?></textarea>
            </div>
            <!---->
                 ...
                 <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                    <div class="i_chck_text" style="padding-right:15px;"><?php echo filter_var($LANG['status'], FILTER_SANITIZE_STRING);?></div>
                        <label class="el-switch el-switch-yellow" for="socialsitestatus">
                          <input type="checkbox" name="socialsitestatus" class="chmdAnnouncementStatus" id="socialsitestatus" value='<?php echo filter_var($sData['status'], FILTER_SANITIZE_STRING);?>' checked="checked">
                        <span class="el-switch-style"></span>  
                        </label> 
                        <input type="hidden" name="socialsitestatus" class="socialsitestatus" <?php echo filter_var($sData['status'], FILTER_SANITIZE_STRING) == 'yes' ? 'value="no" checked="checked"' : 'value="yes"';?>> 
            ...
            <div class="i_modal_g_footer flex_"> 
                ...
                <input type="hidden" name="ssid" value="<?php echo filter_var($sData['id'], FILTER_SANITIZE_STRING);?>">
