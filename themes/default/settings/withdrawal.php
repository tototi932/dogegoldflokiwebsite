    ...
    <div class="i_settings_wrapper_items"> 
         <div class="payouts_form_container">   
            ...
            <div class="i_set_subscription_fee_box">  
               <div class="your_balance"><?php echo filter_var($LANG['your_available_balance'], FILTER_SANITIZE_STRING);?><?php echo $currencys[$defaultCurrency] . ($userWallet);?></div>  
            </div>
            <!--/SET SUBSCRIPTION FEE BOX-->
            <!---->
            <div class="i_settings_wrapper_items">
            ...
            <div class="i_settings_wrapper_item successNot">
               <?php echo html_entity_decode($LANG['withdrawal_success'], FILTER_SANITIZE_STRING)?>
            </div>
         </div>
    </div>
