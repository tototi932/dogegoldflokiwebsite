  ...
  <div class="i_settings_wrapper_in">
     ...
     <div class="i_settings_wrapper_items">
        ...
        <div class="i_settings_wrapper_item">
             ...
             <div class="i_settings_item_title_for">
               <input name="birthdate" type="text" id="date1" class="flnm" maxlength="10" size="10" placeholder="<?php echo filter_var($LANG['birthday_format_placeholder'], FILTER_SANITIZE_STRING);?>" value="<?php echo filter_var($userBirthDay, FILTER_SANITIZE_STRING);?>">
        ...
        <!---->
        <div class="i_settings_wrapper_item">
            <div class="i_settings_item_title"><?php echo filter_var($LANG['social_profiles'], FILTER_SANITIZE_STRING);?></div>
            <div class="i_settings_item_title_for">
        <?php 
...
?>      
                <div class="i_social_link_">
                  ...
                  <input name="<?php echo filter_var($sKey, FILTER_SANITIZE_STRING);?>" class="flnmk" type="text" placeholder="<?php echo filter_var($sPlaceHolder, FILTER_SANITIZE_STRING);?>" value="<?php echo filter_var($userSLink , FILTER_SANITIZE_STRING);?>">
                </div> 
<?php
               }
           }
        ...
        <!---->
        <div class="i_settings_wrapper_item">
             <div class="i_settings_item_title"><?php echo filter_var($LANG['tip_thanks_not'], FILTER_SANITIZE_STRING);?></div>
             <div class="i_settings_item_title_for"> 
               <textarea class="description_" name="tnot" placeholder="<?php echo filter_var($LANG['write_your_thank_note'], FILTER_SANITIZE_STRING);?>"><?php echo filter_var($iN->sanitize_output($thanksNOtForTip,$base_url), FILTER_SANITIZE_STRING);?></textarea> 
             </div>
         </div>
        <!---->
        <?php }?>
