<div class="create_product_form">
    ...
    <div class="create_product_form_column flex_">
        <div class="input_title">
            ...
            <input type="text" id="pr_name" class="prc" placeholder="What are you offering?" value="<?php echo filter_var($LANG['liveeventticket_ex_title'], FILTER_SANITIZE_STRING);?>">
        </div>
    ...
    <div class="create_product_form_column">
        ...
        <div class="col-textarea-box">
            <textarea class="col-textarea" id="pr_description" placeholder="<?php echo filter_var($LANG['pr_description_placeholder'], FILTER_SANITIZE_STRING);?>"><?php echo filter_var($LANG['liveeventticket_ex'],FILTER_SANITIZE_STRING);?></textarea>
        </div>
    </div>
    <!---->
    <!---->
