       ...
       <div class="i_modal_content">  
            ...
            <div class="i_more_text_wrapper">
                ...
                <div class="i_set_subscription_fee_box">
                    <div class="i_set_subscription_fee" id="<?php echo filter_var($tipingUserID, FILTER_SANITIZE_STRING);?>" data-pid="<?php echo filter_var($tipPostID, FILTER_SANITIZE_STRING);?>">
            ...
            <div class="i_block_box_footer_container">
                <div class="send_tip_btn"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('40'));?> <?php echo filter_var($LANG['send_your_tip'], FILTER_SANITIZE_STRING);?></div>
            </div>
            <!--/FOOTER-->
       </div>   
   </div>
