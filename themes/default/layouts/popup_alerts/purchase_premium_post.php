          ...
          <div class="purchase_post_details">
            ...
            <div class="wallet-debit-confirm-container flex_">
               ...
               <?php if($countExplodedFiles){?>
                <?php if(empty($userPostFile) || $userPostFile == '' || !isset($userPostFile)){?>
                 <div class="album-details"><?php echo filter_var($LANG['purchasing'], FILTER_SANITIZE_STRING) .' '; echo filter_var($LANG['purchasing_warning_for_empty_video_and_image'], FILTER_SANITIZE_STRING);?></div>
                <?php }else{?>
