   ...
   <div class="i_modal_in_in"> 
       <div class="i_modal_content">  
            ...
            <div class="i_modal_g_footer">
                <div class="alertBtnRight yes-del-product transition" id="<?php echo filter_var($productID, FILTER_SANITIZE_STRING);?>"><?php echo filter_var($LANG['ok'], FILTER_SANITIZE_STRING);?></div>
