...
<script type="text/javascript" src="<?php echo filter_var($base_url, FILTER_VALIDATE_URL);?>themes/<?php echo filter_var($currentTheme, FILTER_SANITIZE_STRING);?>/js/crop/croppie.js?v=091<?php echo filter_var($version, FILTER_SANITIZE_STRING);?>"></script>
