...
<?php } else if($alertType == 'shared_storie_success'){?>
<div class="i_bottom_left_alert_container warning_alert animated fadeInUp">
<div class="i_alert_wrapper">
<div class="i_alert_close transition"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('5'));?></div>
  <div class="i_alert_icon_tick">
  ...
  <div class="i_alert_notes">
      <div class="i_alert_title">
         <?php echo filter_var($LANG['storie_shard'], FILTER_SANITIZE_STRING);?>
      </div>
      <div class="i_alert_desc">
      <?php echo filter_var($LANG['storie_shared_success'], FILTER_SANITIZE_STRING);?>
      </div>
  </div>
</div>
</div>
<?php }else if($alertType == 'cnbowni'){?>
<div class="i_bottom_left_alert_container warning_alert animated fadeInUp">
  <div class="i_alert_wrapper">
  <div class="i_alert_close transition"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('5'));?></div>
    <div class="i_alert_icon">
    ...
    <div class="i_alert_notes">
        <div class="i_alert_title">
           <?php echo filter_var($LANG['come_on'], FILTER_SANITIZE_STRING);?>
        </div>
        <div class="i_alert_desc">
        <?php echo filter_var($LANG['you_can_not_buy_your_own_product'], FILTER_SANITIZE_STRING);?>
        </div>
    </div>
  </div>
</div> 
<?php }else if($alertType == 'tipSuccess'){?>
<div class="i_bottom_left_alert_container warning_alert animated fadeInUp">
<div class="i_alert_wrapper">
<div class="i_alert_close transition"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('5'));?></div>
  <div class="i_alert_icon_tick">
  ...
  <div class="i_alert_notes">
      <div class="i_alert_title">
         <?php echo filter_var($LANG['tip_sended_success'], FILTER_SANITIZE_STRING);?>
      </div>
      <div class="i_alert_desc">
      <?php echo filter_var($LANG['thanks_for_kind_gift'], FILTER_SANITIZE_STRING);?>
      </div>
  </div>
</div>
</div>
