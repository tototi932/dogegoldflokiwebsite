   ...
   <div class="i_modal_in_in"> 
       <div class="i_modal_content">  
            ...
            <div class="i_modal_g_header">
                <?php echo filter_var($LANG['close_live_streaming'], FILTER_SANITIZE_STRING);?>
            ...
            <div class="i_delete_post_description">
               <?php echo filter_var($LANG['close_live_streaming_not'], FILTER_SANITIZE_STRING);?>
            </div>
            <!--Modal Header-->
            <div class="i_modal_g_footer">
                <div class="alertBtnRight camclose transition"><?php echo filter_var($LANG['ok'], FILTER_SANITIZE_STRING);?></div>
