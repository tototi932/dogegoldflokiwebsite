...
<div class="i_direct_login" style="text-align:left;">
  ...
  <div class="con_warning_rec" style="text-align:center;width:100%;padding:20px;font-weight:600;font-size:16px;color:#8e24aa; display:none;"><?php echo filter_var($LANG['prove_you_are_not_robot'], FILTER_SANITIZE_STRING);?></div>
  <div id="con_for">
