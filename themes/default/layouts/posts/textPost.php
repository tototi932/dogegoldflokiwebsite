...
echo html_entity_decode($pPinStatus); ?>
    ...
    <div class="i_post_container" id="i_post_container_<?php echo filter_var($userPostID, FILTER_SANITIZE_STRING); ?>">
        <!--POST TEXT-->
        <div class="i_post_text" id="i_post_text_<?php echo filter_var($userPostID, FILTER_SANITIZE_STRING); ?>" style="margin-bottom:15px;">
        <?php
$pStatus = '1';
/*********************************/
...
?>
    ...
    ,ter_item">
        ...
        <?php }?>
        <div class="i_post_footer_item">
            <div class="i_post_item_btn transition in_comment" id="<?php echo filter_var($userPostID, FILTER_SANITIZE_STRING); ?>"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('20')); ?></div>
        </div>
        <div class="i_post_footer_item">
    ...
    <div class="i_post_comments_wrapper">
        <div class="i_post_comments_box" id="all_comments_<?php echo filter_var($userPostID, FILTER_SANITIZE_STRING); ?>">
            <!--USER COMMENTS-->
            <div class="i_user_comments" id="i_user_comments_<?php echo filter_var($userPostID, FILTER_SANITIZE_STRING); ?>">
            <?php
