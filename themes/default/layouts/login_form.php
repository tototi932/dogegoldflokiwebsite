        ...
        <?php if ($socialLoginStatus == '1') {
            ...
            if ($socialLogins) {
                ...
                foreach ($socialLogins as $sL) {
                    ...
                    $sIcon = $sL['s_icon'];
                    ?>
                    <div><a class="<?php echo filter_var($sKey, FILTER_SANITIZE_STRING); ?>-login" href="<?php echo filter_var($base_url, FILTER_VALIDATE_URL) . $sKey; ?>Login"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon($sIcon)); ?><span><?php echo filter_var($LANG[$sKey], FILTER_SANITIZE_STRING); ?></span></a></div>
                <?php }
       ...
       <div class="i_modal_content">
           ...
           <div class="i_login_box_header">
            ...
            <div class="i_direct_login s_e">
                   ...
                   <div class="system_no_send flex_ tabing minimum_character_not" style="padding-left:25px;padding-bottom:10px;"><?php echo filter_var($LANG['write_your_email'], FILTER_SANITIZE_STRING); ?></div>
                    <div class="form_group">
